...
<body class="bg-gradient-to-br from-purple-50 to-indigo-100 min-h-screen py-12 px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold bg-gradient-to-r from-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Tambah Dosen</h1>
        ...
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden border border-gray-200">
            <form method="POST" action="{{ route('dosens.store') }}" class="p-10">
                @csrf
