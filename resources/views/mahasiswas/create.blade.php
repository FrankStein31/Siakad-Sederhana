...
<body class="bg-gradient-to-br from-emerald-50 to-teal-100 min-h-screen py-12 px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold bg-gradient-to-r from-emerald-800 to-teal-700 bg-clip-text text-transparent mb-4">Tambah Mahasiswa</h1>
        ...
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden border border-gray-200">
            <form method="POST" action="{{ route('mahasiswas.store') }}" class="p-10">
                @csrf
